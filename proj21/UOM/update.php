...
<form class="was-validated" id="uform">
<div class="form-group row">

<label  for="UomCode" class="col-sm-2 col-form-label">Unit of Measure</label>
                    <div class="col-sm-10">
                    <input type="text" disabled id="UomCode" class="form-control" name="UomCode"   maxlength="5" required />
...
<div class="form-group row" style="margin-top:5px;">
                ...
                <div class="col-sm-10">
                    <input type="text" id="UOMDesc" name="UomDesc" class="form-control"  maxlength="25" required/>
...
<div class="col-sm-10">
                    ...
                    <input class="form-check-input" type="checkbox"  name="RoundT" id="RoundT" >
...
<div class="form-group row"  style="margin-top:5px;">
                <label  for="title" class="col-sm-2 col-form-label">Round Upto</label>
                    <div class="col-sm-10">
                    <input type="number" min="1" max="5" id="RoundUpto"  name="RoundUpto"  class="form-control" data-error="Please enter Item Type." />
...
<button id="backbtn" reset  class="btn btn-secondary" onclick="window.location.assign('view.php');  return false;">Go Back</button>
    </div>
